...
class CartService {
            ...
            // - yes
                ...
                for (let i = 0; i < product.selectedVariants.length; i++) {
                    ...
                    // - yes
                        ...
                        previousQuantity = productInCart.selectedVariants[variantIndex].quantity;
                        newQuantity = previousQuantity + product.selectedVariants[i].quantity;
    ...
    async deleteProductFromCart({ userId, productId, variantId }) {
        ...
        const deletedVariant = deletedProductData.selectedVariants.find(variant => variant.variantId == variantId)
